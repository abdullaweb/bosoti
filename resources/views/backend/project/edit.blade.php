                                ...
                                <form action="{{ isset($project) ? route('admin.project.update', $project) : route('admin.project.store') }}" method="POST" enctype="multipart/form-data">
                                    ...
                                    <div class="mb-3">
                                        <div class="form-group row">
                                            <div class="col-md-12">
                                                ...
                                                <textarea class="summernote" name="description" required data-parsley-required-message="project Long Description is required*">{{ old('description') ?? $project->description }}</textarea>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <select name="status" class="">
                                            <option value="upcoming" {{ old('status', $project->status ?? '') == 'upcoming' ? 'selected' : '' }}>
                                                Upcoming
                                            </option>
                                    ...
                                    <div class="form-group row mb-4">
                                        <div class="col-md-8">
                                            ...
                                            <div id="image-preview" class="image-preview">
                                                ...
                                                <input type="file" name="project_image" id="image-upload" data-parsley-required-message="project Image is required*" />
                                    ...
                                    <div class="form-group row mb-4">
                                        <div class="col-md-8">
                                            ...
                                            <textarea name="meta_description" rows="4" class="form-control">{{ old('meta_description') ?? $project->meta_description }}</textarea>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group row mb-4">
                                        <div class="col-md-8">
                                            ...
                                            <input type="text" class="form-control" name="meta_keyword" value="{{ old('meta_keyword') ?? $project->meta_keyword }}">
                                        </div>
                                    </div>
