...
class ServiceController extends Controller
{
    public function ServiceList()
    {
        ...
        return view('backend.service.list', compact('title', 'services'));
    } // End Method
    ...
    public function ServiceStore(Request $request)
    {
        $validator = Validator::make(
            ...
            [
                ...
                'service_category_id.integer' => 'Service category must be an integer',
                'service_category_id.exists' => 'Service category is not found',
        ...
        try {
            ...
            $serviceDetails->service_category_id = $request->service_category_id;
    ...
    public function ServiceEdit($id)
    {
        ...
        $serviceDetails = $service->serviceDetail ?? new ServiceDetails();
