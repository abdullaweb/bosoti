...
class AboutUsController extends Controller
{
    ...
    public function AboutMessageUpdate(Request $request)
    {
        ...
        try {
            ...
            return redirect()->route('admin.about-message.list')->with('success', 'Chairman Message Updated Successfully');
        } catch (\Exception $e) {
            DB::rollBack();

            Log::error('Error occurred while updating chairman message: ' . $e->getMessage());
